...
export const projectsData = [
  {
    ...
    description:
      'Full-stack file management application with secure file sharing, JWT and OAuth2 authentication, AES-256-CBC file encryption, configurable access limits and expiration.',
    ...
    image: '/projects/secure-file-sharing.png',

    // Replace with your actual GitHub repository
    code: 'https://github.com/yourusername/secure-file-sharing',

    // Replace with your actual deployed project
...

  {
    ...
    description:
      'Full-stack student management application with CRUD operations, Spring Boot REST APIs, search, pagination, form validation and a responsive React frontend.',
...

  {
    ...
    description:
      'Scalable online food ordering application built with Spring Boot, RESTful APIs and MySQL for efficient restaurant and customer order management.',
    ...
    image: '/projects/online-food-order.png',

    // Replace with your actual GitHub repository
    code: 'https://github.com/yourusername/online-food-order',
